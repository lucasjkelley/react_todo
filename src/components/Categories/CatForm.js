...
import { Formik, Form, Field } from 'formik'//These will produce the form for create/edit of a category
...
export default function CatForm(props) {
    const handleSubmit = (values) => {
        ...
        if(!props.category){
            ...
            axios.post(`http://todoapi.lucasjkelley.com/api/Categories`, catToCreate).then(() => {
            ...
            axios.put(`http://todoapi.lucasjkelley.com/api/Categories/${props.category.categoryId}`, catToEdit).then(() => {
            ...
            {({errors, touched}) => (
                <Form id='catForm' className='row text-center m-auto'>
                    ...
                    <div className="form-group m-1">
                        <button type='submit' className="btn btn-success">Submit Changes to API</button>
                    </div>
                </Form>
            )}
        </Formik>    
